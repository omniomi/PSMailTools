...
[cmdletbinding()]
param(
    [ValidateSet('Build','Test','BuildHelp','Install','Clean','Analyze','Publish','ExportPublicFunctions','VersionIncMajor','VersionIncMinor','VersionIncBuild','VersionIncRevision')]
    [string[]]$Task = 'Build'
)
